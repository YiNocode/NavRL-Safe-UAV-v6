...
if V6_VOXEL_REWARD_V3_TASK_ID not in gym.registry:
    gym.register(
        id=V6_VOXEL_REWARD_V3_TASK_ID,
        entry_point=f"{__name__}.v6_voxel_reward_v3_env:V6FrontDepthVoxelRewardV3Env",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": (
                f"{__name__}.v6_voxel_reward_v3_env:V6FrontDepthVoxelRewardV3EnvCfg"
            ),
            "rsl_rl_cfg_entry_point": (
                f"{__name__}.agents.v6_voxel_reward_v3_rsl_rl_ppo_cfg:"
                "V6VoxelRewardV3NavRLGpuPPORunnerCfg"
            ),
        },
    )
